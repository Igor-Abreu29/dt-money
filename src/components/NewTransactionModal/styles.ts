...
export const TransactionsTypes = styled(RadioGroup.Root)`
    display: grid;
...
interface TransactionsTypesButtonProps {
    variant: 'income' | 'outcome'
}

export const TransactionsTypesButton = styled(RadioGroup.Item)<TransactionsTypesButtonProps>`
